...
namespace chameleon {
    ...
    /// logarithmic_display_renderer handles openGL calls for a display.
    class logarithmic_display_renderer : public QObject, public QOpenGLFunctions_3_3_Core {
        Q_OBJECT
        public:
        logarithmic_display_renderer(
            QSize canvas_size,
            float discard_ratio,
            std::size_t colormap,
        ...
        logarithmic_display_renderer(const logarithmic_display_renderer&) = delete;
        logarithmic_display_renderer(logarithmic_display_renderer&&) = default;
        logarithmic_display_renderer& operator=(const logarithmic_display_renderer&) = delete;
        logarithmic_display_renderer& operator=(logarithmic_display_renderer&&) = default;
        virtual ~logarithmic_display_renderer() {
    ...
    /// logarithmic_display displays a stream of events.
    class logarithmic_display : public QQuickItem {
        Q_OBJECT
        ...
        logarithmic_display() :
            ...
            connect(this, &QQuickItem::windowChanged, this, &logarithmic_display::handle_window_changed);
            _accessing_renderer.clear(std::memory_order_release);
        }
        logarithmic_display(const logarithmic_display&) = delete;
        logarithmic_display(logarithmic_display&&) = default;
        logarithmic_display& operator=(const logarithmic_display&) = delete;
        logarithmic_display& operator=(logarithmic_display&&) = default;
        virtual ~logarithmic_display() {}
        ...
        virtual void set_discards(QVector2D discards) {
            ...
            if (_renderer_ready.load(std::memory_order_relaxed)) {
                _logarithmic_display_renderer->set_discards(discards);
            } else {
        ...
        void push(Event event) {
            ...
            _logarithmic_display_renderer->push<Event>(event);
        }
        ...
        void assign(Iterator begin, Iterator end) {
            ...
            _logarithmic_display_renderer->assign<Iterator>(begin, end);
        }
        ...
        void sync() {
            if (_ready.load(std::memory_order_relaxed)) {
                if (!_logarithmic_display_renderer) {
                    _logarithmic_display_renderer =
                        std::unique_ptr<logarithmic_display_renderer>(new logarithmic_display_renderer(
                            _canvas_size, _discard_ratio, static_cast<std::size_t>(_colormap), _background_color));
                    connect(
                        window(),
                        &QQuickWindow::beforeRendering,
                        _logarithmic_display_renderer.get(),
                        &logarithmic_display_renderer::paint,
                        Qt::DirectConnection);
                    connect(
                        _logarithmic_display_renderer.get(),
                        &logarithmic_display_renderer::discards_changed,
                        this,
                        &logarithmic_display::update_discards);
                    while (_accessing_renderer.test_and_set(std::memory_order_acquire)) {
                    }
                    _logarithmic_display_renderer->set_discards(_discards_to_load);
                ...
                if (clear_area != _clear_area) {
                    ...
                    _logarithmic_display_renderer->set_rendering_area(
        ...
        void cleanup() {
            _logarithmic_display_renderer.reset();
        }
        ...
        void handle_window_changed(QQuickWindow* window) {
            if (window) {
                connect(
                    window, &QQuickWindow::beforeSynchronizing, this, &logarithmic_display::sync, Qt::DirectConnection);
                connect(
                    window,
                    &QQuickWindow::sceneGraphInvalidated,
                    this,
                    &logarithmic_display::cleanup,
                    Qt::DirectConnection);
        ...
        QColor _background_color;
        std::unique_ptr<logarithmic_display_renderer> _logarithmic_display_renderer;
        QRectF _clear_area;
        QRectF _paint_area;
    };
}
